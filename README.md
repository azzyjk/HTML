...
HTML은 HyperText Markup Language의 약자로 웹페이지의 모습을 기술하기 위한 규약이다.
...
```html
<img
  src="https://image.shutterstock.com/image-photo/mountain-peak-everest-highest-world-600w-598924397.jpg"
/>
```
...
HTML등의 마크업 언어로 작성된 문서가 실제로 웹사이트에 표현되는 방법을 정해주는 언어이다.
